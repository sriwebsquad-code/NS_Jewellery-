...
router.post('/categories', upload.single('image'), jewellery_controller_1.createCategory);
router.get('/categories', jewellery_controller_1.getCategories);
router.post('/items', upload.single('image'), jewellery_controller_1.createJewelleryItem);
