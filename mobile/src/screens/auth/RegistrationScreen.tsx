...
import { ArrowRight, User, Mail, MapPin, Calendar } from 'lucide-react-native';
...
const RegistrationScreen = () => {
  ...
  const handleSaveProfile = async () => {
    if (!name || !email) {
      alert('Please fill at least your Name and Email');
      return;
    }
    ...
    try {
      ...
      if (data.success) {
        updateUser({ 
          ...
          address, 
          dob,
          isNewUser: false // This will trigger AppNavigator to move to CreateMPIN
        });
      } else {
